...
For Chart # we decided to create a trendline based on popularity of google trends from 2019 to present day. Virtual Reality (VR) games were by far the most popular, doubling and tripling the amounts of other genres. This may be due to the realse of popular VR games _Hitman 3_, _I Expect You to Die 2_, and _Lone Echo2_. It may also be due the Covid-19 pandemic, and the increased need for entertainment that didn't involve person to person contact. Virtual Reality games allow for an experence and movement similar to that of an outdoor actviity, but within the confinment of your home.
